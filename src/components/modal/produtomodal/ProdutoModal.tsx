    ...
    >
      ...
      >
        <div className="flex justify-between items-start p-6 border-b border-gray-100 sticky top-0 bg-white z-10">
          <h2 className="text-3xl font-extrabold text-nutri-gray leading-tight">
        ...
        <div className="grid md:grid-cols-2 gap-8 p-8">
          ...
          <div className="md:col-span-1 space-y-5">
              ...
              <span
                className={`text-sm font-semibold px-3 py-1 rounded-full ${
                  produto.quantidade > 0
                    ? "bg-emerald-200 text-nutri-gray"
            ...
            <div className="pt-2 border-t border-gray-100 grid grid-cols-2 gap-4">
              <div>
                <h4 className="text-sm font-bold text-gray-700">Categoria</h4>
            ...
            <div className="pt-4">
              <button
                ...
                className="select-none rounded-lg bg-nutri-green-dark w-full py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-blue-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
              >
                {produto.quantidade > 0
