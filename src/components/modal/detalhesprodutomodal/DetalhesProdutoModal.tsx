    ...
    return (
        ...
        >
            <div className="flex justify-between items-start p-4 sm:p-6 border-b border-gray-100 sticky top-0 z-1 bg-white">
                <h2 className="text-lg sm:text-xl lg:text-3xl font-extrabold text-gray-900 leading-tight pr-2 line-clamp-2">
            ...
            <div className="flex-1 overflow-y-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 p-4 sm:p-8">
                    <div className="flex justify-center items-center bg-gray-50 rounded-xl overflow-hidden h-48 sm:h-64 lg:h-auto lg:max-h-96">
                        <img
                            src={produto.foto || ""}
                    ...
                    <div className="space-y-4 sm:space-y-5 flex flex-col">
                        ...
                        <div className="pt-2 border-t border-gray-100 grid grid-cols-2 gap-4">
                            <div>
                                <h4 className="text-xs sm:text-sm font-bold text-gray-500">
                                    Categoria
                                </h4>
